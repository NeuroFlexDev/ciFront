  ...
  const [courses] = useState([
    {
      ...
      description: "Этот курс поможет вам освоить базовые концепции Python, научиться работать с переменными, циклами, функциями и основами ООП",
      status: 0,
      img: pythonCourse
    },
    {
      ...
      description: "Научитесь продвигать бизнес в , анализировать эффективность рекламных кампаний и привлекать аудиторию.",
      status: 1,
      img: marketingCourse
    },
    {
        ...
        description: "Разберём, как подготовиться к выступлению, управлять голосом, жестикуляцией и привлекать внимание аудитории",
        status: 2,
        img: artCourse
    },
    {
  ...
  return (
    <>
      ...
      <div className={styles.containerCoursePage}>
        ...
        <Link className={styles.newCourseLink} to="/"><NewCourse /></Link>
      </div>
      <Footer />
    </>
  );
